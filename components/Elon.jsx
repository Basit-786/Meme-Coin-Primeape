...
const Elon = () => {
  return (
    <div className="bg-primary max-w-7xl mx-auto rounded-2xl py-16 px-6 flex  flex-wrap items-center justify-between my-32 pb-80 lg:pb-20">
      <motion.div
        initial={{ x: -300 }}
        whileInView={{ x: 0 }}
        transition={{ duration: 0.7 }}
        className="py-8 md:px-6 w-full lg:w-[60%]"
      >
        <h1 className="text-3xl lg:text-5xl leading-[55px] text-outline uppercase pb-5 logo text-wrap">
