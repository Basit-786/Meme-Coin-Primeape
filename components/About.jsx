...
const About = () => {
  return (
    <div className="flex items-center justify-center px-4 min-h-screen flex-wrap-reverse my-20 md:my-12 max-w-7xl mx-auto">
      ...
      >
        <h1 className="text-4xl md:text-5xl text-outline uppercase text-center pb-5 logo">
          What is PRMAPE
        </h1>
        <p className="text-xl leading-10 text-center">
          ...
          side. PrimeApe doesn’t believe in constant updates over telegram or
          discord but when time comes, this Ape is going to launch everything.{" "}
